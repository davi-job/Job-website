			...
			<div className="products-container container flex">
				...
				>
					<LazyImg
						...
						src="/images/Produtos/produtos-antichama.webp"
						alt="hero"
						hasSmall={true}
					/>
				...
				>
					<LazyImg
						className="products-card-bg-image"
						src="/images/Produtos/produtos-social.webp"
						alt="hero"
						hasSmall={true}
					/>
				...
				>
					<LazyImg
						className="products-card-bg-image"
						src="/images/Produtos/produtos-hospitalar.webp"
						alt="hero"
						hasSmall={true}
					/>
				...
				>
					<LazyImg
						className="products-card-bg-image"
						src="/images/Produtos/produtos-profissional.webp"
						alt="hero"
						hasSmall={true}
					/>
				...
				>
					<LazyImg
						className="products-card-bg-image"
						src="/images/Produtos/produtos-malha.webp"
						alt="hero"
						hasSmall={true}
					/>
